function [path_parameters, path_weights, remainder] = rimax_iteration(varargin)
...
function run_unitary_test()
    ...
    for n=2:num_observations
        ...
        [path_parameters{n}, path_weights{n}] = rimax_iteration(channel_observation, path_parameters{n-1}, ...
